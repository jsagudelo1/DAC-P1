...
$Mostrar= consultar_reporte_venta($dfecha,$hfecha,$id);
    ...
    <table class="table" id="tabla1">
        ...
        while($fila = Mysqli_fetch_array($sql)){
            ...
            <tr>
                ...
                <td> <center> <?php echo $fila ['vendido1']?> </center> </td>
                <td><a href="form_detalles_report2.php?fecha='<?php echo $fila['fecha_entrega'];?>'&idve='<?php echo $id;?>'"> <center> VER DETALLES </center> </td>
