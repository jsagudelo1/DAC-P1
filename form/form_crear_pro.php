    ...
    <div>
        ...
        <td>
          <div class="input-group input-group-sm mb-3">
              ...
              <input type="text" class="form-control" name= "txt_id_pro" id="txt_num_doc" maxlength="5" onkeypress="return soloNumeros(event)" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" required>
        ...
        <td>
          <div class="input-group input-group-sm mb-3">
              <div class="input-group-prepend">
                <span class="input-group-text" id="inputGroup-sizing-sm">Cantidad min bodega</span>
              </div>
