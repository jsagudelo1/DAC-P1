...
include "maqueta.php";
$idcone=conexion();
$documentos=obtener_estado_gasto();
...
<form method="POST" action="../program/program_agregar_gasto.php" onsubmit="return AgregarAlInventario()" class="needs-validation" novalidate>

    <div>Efectuar gasto</div><br><div>
